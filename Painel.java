...
public class Painel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Controle de Produto");
...
{                                         
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            double preco = Double.parseDouble(jTextField2.getText().replace("R$", "").trim());
            int quantidade = (int) jSpinner1.getValue();
            double desconto = Double.parseDouble(jTextField3.getText().replace("%", "").trim());
            double precoComDesconto = preco * ((100 - desconto) / 100);
            double valorTotal = precoComDesconto * quantidade;
            jLabel6.setText("Valor Total: R$ " + String.format("%.2f", valorTotal));
            ...
            "Preço com Desconto: R$ " + String.format("%.2f", precoComDesconto) + "\n" +
            "Valor Total: R$ " + String.format("%.2f", valorTotal),
            "Resumo da Compra", JOptionPane.INFORMATION_MESSAGE);
        }
        catch (NumberFormatException e) {
        jLabel6.setText("Erro nos valores!");
